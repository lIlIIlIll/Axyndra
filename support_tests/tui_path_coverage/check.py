...
def clean_environment(home: Path, workspace: Path, case_dir: Path, *, port: int = 0) -> dict[str, str]:
    ...
    path_entries = [
        ...
        "/bin",
        "/usr/local/bin",
        "/home/elliot/cangjie_sdk/daily/cangjie/bin",
        "/home/elliot/cangjie_sdk/daily/cangjie/tools/bin",
    ]
    ...
    environment.setdefault("CANGJIE_HOME", "/home/elliot/cangjie_sdk/daily/cangjie")
    environment.setdefault("CANGJIE_SDK_ROOT", "/home/elliot/cangjie_sdk/daily/cangjie")
    environment.setdefault(
        "CANGJIE_STDX_PATH",
        "/home/elliot/cangjie_sdk/daily/linux_x86_64_cjnative/dynamic/stdx",
    )
    native = str(ROOT / "libs" / "process4cj" / "native")
    runtime = "/home/elliot/cangjie_sdk/daily/cangjie/runtime/lib/linux_x86_64_cjnative"
    tools = "/home/elliot/cangjie_sdk/daily/cangjie/tools/lib"
